    ...
    return (
        <footer className='fluid gridContainer w-full px-2 pb-0.5 mt-12'>
            <section className='relative w-full bg-gradient-to-b from-black to-[#1b1b1b] rounded-xl min-h-96 max-h-96'>
                <Image src={"/images/xencoa-logo-item-top.webp"} alt='xencoa logo item' width={200} height={200} className="absolute -top-3 -left-3 w-fit h-20 lg:h-36 skew-x-[11deg] skew-y-[5deg] drop-shadow-[6px_6px_5px_black]" />
